...
function OpenModelWindow(url, option) {
    var fun;
    try {
        if (parent != null && parent.$j != null && parent.$.ShowIfrmDailog != undefined) {
...
function OpenModelWindowRev(url, option) {
    var fun;
    try {
        if (parent != null && parent.$ != null && parent.$.ShowIfrmDailogRev != undefined) {
            fun = parent.$.ShowIfrmDailogRev;
        }
        else {
            fun = $.ShowIfrmDailogRev;
        }
    }
    catch (e) {
        fun = $.ShowIfrmDailogRev;
...
function CloseModelWindowRevised(callback, dooptioncallback) {
	parent.$.closeIfrmRevised(callback, dooptioncallback);
}
