<section class="content">
    ...
    <div class="container-fluid">
        <ol class="breadcrumb <?php echo BREADCRUMB_COLOR_CLASS;?>">
            ...
            <li class="active"><a href="javascript:void(0);"><i class="material-icons">library_books</i> <?php __("Passengers Manager");?></a></li>
        </ol>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body table-responsive">
                        ...
                        ?>
                        <?php $this->set("title_for_layout", "Passengers Manager");?>
                        <?php echo $this->element('admin/addlink', array('linkNameAction' => 'users', 'linkName' => 'Registered Member'));?>
                        <?php echo $this->element('users/store_search_config');?>
                                    ...
                                    foreach ($users as $user):
                                        ...
                                        <tr<?php echo $class;?>>
                                         ...
                                         <!--   <td><?php echo $user['Group']['name'];?></td>-->
                                            <td><?php echo $html->link($user['User']['u_email'], array('action' => 'storeedit', $user['User']['user_id']), array('escape' => false));?></td>
                                            <td><?php echo $html->link($user['User']['u_name'], array('action' => 'storeedit', $user['User']['user_id']), array('escape' => false));?></td>
                                            ...
                                            <?php
                                            $disabledFlag = false;
                                            echo $form->input('User.'.($i-1).'.id', array('label'=>true, 'type'=>'checkbox', 'value'=>$user['User']['user_id'],'disabled'=>$disabledFlag));
                                            ?>
                                            </td>
