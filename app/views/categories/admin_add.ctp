<section class="content">
    <div class="container-fluid">
        <ol class="breadcrumb <?php echo BREADCRUMB_COLOR_CLASS;?>">
            ...
            <li class="active"><a href="javascript:void(0);"><i class="material-icons">library_books</i> <?php __("Add Category");?></a></li>
        </ol>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body demo-masked-input">
                        ...
                        <?php echo $form->create('Category', array('action'=>'add','type'=>'file','id'=>"form_validation"));?>
