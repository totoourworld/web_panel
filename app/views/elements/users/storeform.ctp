...
<div class="form-group form-float">
    <div class="form-line">
        <?php echo $form->input('User.u_phone' , array('div'=>false,'label'=>false,'class' => 'form-control','required'=>'required','id'=>'mask_phone'));?>
...
<a href="<?php echo $this->base;?>/admin/users/storeindex" class="btn">Cancel</a>